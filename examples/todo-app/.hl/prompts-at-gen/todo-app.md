...
- Add a todo by typing into a text input and pressing Enter. Adding trims
  surrounding whitespace and ignores empty input. The input clears after a todo
  is added.
- Each todo has a checkbox that toggles its done state. A done todo shows its
  text with a line-through strikethrough style.
